"""Train a three-layer TabPFN core that is recurrently applied six times.

Each recurrence applies the same ordered stack of three physical Transformer
layers, producing 18 effective layers while sharing parameters across loops.
"""
...
LOG_FILE_PATH = "looped_transformer_3physical_core6x.log"
...
checkpoint_model_name = "new_looped_transformer_3physical_core6x"
...
device = os.environ.get("TRAIN_DEVICE", "cuda:3")
...
# Save three-physical-layer, 18-effective-layer recurrent TabPFN model
