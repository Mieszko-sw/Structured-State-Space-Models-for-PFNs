"""Train a one-layer TabPFN whose Transformer block is recurrently applied 18 times.

At every recurrence, the block receives its previous output; all 18 effective
...
LOG_FILE_PATH = "looped_transformer_1physical_core18x.log"
...
checkpoint_model_name = "new_looped_transformer_1physical_core18x"
...
config["looped_core_repeat_pattern"] = [18]
config["lr"] = 1e-4
...
# Save one-physical-layer, 18-effective-layer recurrent TabPFN model
