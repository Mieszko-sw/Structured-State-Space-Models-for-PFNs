"""Train an elastic one-layer TabPFN with a maximum of 12 recurrent passes.

Each update uses the full 12-loop trajectory and one uniformly sampled shorter
trajectory. The loss combines full CE, shortcut CE, and detached full-to-short
...
LOG_FILE_PATH = "elastic_looped_transformer_1physical_core12x.log"
...
checkpoint_model_name = "elastic_looped_transformer_1physical_core12x"
...
# Elastic shortcut-distillation objective. One shortcut budget is sampled per batch.
config["elastic_shortcut_training"] = True
config["elastic_max_loops"] = 12
...
# Save the elastic one-physical-layer, maximum-12-loop TabPFN model
