"""Train a one-layer TabPFN whose Transformer block is recurrently applied 6 times.

At every recurrence, the block receives its previous output; all 6 effective
...
LOG_FILE_PATH = "looped_transformer_1physical_core6x.log"
...
checkpoint_model_name = "new_looped_transformer_1physical_core6x"
...
config["looped_core_repeat_pattern"] = [6]
config["lr"] = 1e-4
...
# Save one-physical-layer, 6-effective-layer recurrent TabPFN model
