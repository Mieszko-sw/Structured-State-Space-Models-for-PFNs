...
def parse_args():
    parser = argparse.ArgumentParser(
        description=(
            "Measure synchronized wall-clock inference speed for Hybrid 8L, TabPFN, "
            "and Hydra at 32k context length on TabArena-v0.1 classification datasets "
    ...
    parser.add_argument(
        "--raw-csv",
        default=os.path.join("result_csvs", "per_dataset_speed_synchronized_long_context_raw_tabarena_16.csv"),
    )
    parser.add_argument(
        "--summary-csv",
        default=os.path.join("result_csvs", "per_dataset_speed_synchronized_long_context_summary_tabarena_16.csv"),
    )
